...
void test_riscv_copy_to_reg_64bits()
{
	...
	TEST_ASSERT_EQUAL_HEX64(0, *(uint64_t*)&w[1]); // .dword 0
	...
	TEST_ASSERT_EQUAL_HEX64(0x1234567823456789, *(uint64_t*)&w[10]); // .dword 0x1234567823456789
	...
	TEST_ASSERT_EQUAL_HEX64(0xEDCBA987EDCBA988, *(uint64_t*)&w[19]); // .dword -0x123457823456789
